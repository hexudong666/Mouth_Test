...
<!-- 新的方法,报错 -->
<link href="<%=request.getContextPath()%>bootstrap-4.3.1/css/bootstrap.css" rel="stylesheet">
<script type="text/javascript" src="<%=path%>/bootstrap-4.3.1/js/bootstrap.js"></script>
</head>
<body>
	胡鹏骚是憨批
</body>
